...
| Satellite | Natural color satellite image with border overlay | `natural_color` |

Configuration options:
- Single product (any of the above)
- All radar maps (CMAX + SRI + PAC)
- All maps + satellite (CMAX + SRI + PAC + satellite)

Each radar image includes a color scale with values (dBZ, mm/h, mm) and measurement timestamp.
